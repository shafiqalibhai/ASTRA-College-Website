 ...
 */
	...
	// if DOCUMENT_ROOT does not exist, construct it
	...
	if ($settings['max_thumbnails']<=0) {
		...
		$alert_message[] = "Max number of thumbnails cannot be 0, it has been set to 6. Please check your settings in the /config/settings.php file";
	}
