<?php
/*
detects and blocks unwanted Web accesses
*/
...
function bb2_email() {
	...
	return "shafiqissani@gmail.com";	// You need to change this.
}
...
function bb2_insert_stats($force = false) {
	...
	if ($force || $settings['display_stats']) {
		...
		if ($blocked !== FALSE) {
			echo sprintf('<p>%1$s %2$s <strong>%3$s</strong> %4$s</p>', __(''), __('blocked'), $blocked[0]["COUNT(*)"], __('access attempts in the last 7 days.'));
		}
	}
}
