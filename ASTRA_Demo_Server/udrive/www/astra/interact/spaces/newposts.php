...
* @version $Id: newposts.php,v 1.27 2007/01/07 22:25:30 glendavies Exp $
* 
*/
...
$days = isset($_GET['days'])?$_GET['days']:'last_login';
$view = isset($_GET['view'])? $_GET['view'] : '';
$space_key  = isset($_GET['space_key'])? $_GET['space_key'] : '';
$show_read_posts = isset($_GET['show_read_posts'])? $_GET['show_read_posts'] : '';
$show_flagged_posts = isset($_GET['show_flagged_posts'])? $_GET['show_flagged_posts'] : ''; 
...
function get_users_posts()
{
	...
	global $CONN, $t,$userlevel_key,$accesslevel_key,$space_key,$module_key,$post_key,$thread_key,$user_key, $current_user_key,$last_use,$days,$post_statuses, $forum_strings, $CONFIG, $view, $objForum, $show_read_posts, $show_flagged_posts, $objDates, $objHtml;
	...
	if ($rs->EOF) {
		...
		while (!$rs->EOF) {
			...
			if ((!isset($post_statuses['read'][$post_key2]) || $post_statuses['read'][$post_key2]!=1) || ($show_read_posts==1 && $post_statuses['read'][$post_key2]==1) || ($view=='follow_ups' && (isset($post_statuses['flags'][$post_key2]) && $post_statuses['flags'][$post_key2]==1)) || (isset($show_flagged_posts) && $show_flagged_posts==1)) {
