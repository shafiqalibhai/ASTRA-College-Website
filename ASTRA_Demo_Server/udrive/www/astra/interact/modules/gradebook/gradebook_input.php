...
* gradebook module
*
* Inputs/modifies/deletes a gradebook module 
*
* @package gradebook
* @author Glen Davies <glen.davies@cce.ac.nz>
* @copyright Christchurch College of Education 2001 
* @version $Id: gradebook_input.php,v 1.16 2007/07/30 01:57:00 glendavies Exp $
* 
*/
...
$modules->set_module_type('gradebook');
...
if (isset($_POST[submit])) {
    ...
    switch($_POST[submit]) {
        ...
        //if we are adding a new gradebook form input needs to be checked 
        ...
        case $general_strings['add']:
            ...
            if(count($errors) == 0) {
                ...
                $message = $modules->add_module('gradebook');


            //if the add was successful return the browser to space home or parent gradebook
                if ($message=='true') {
                     
                    $modules->return_to_parent('gradebook','added');
                    exit;
        ...
        case $general_strings['modify']:
            ...
            if(count($errors) == 0) {
                 ...
                 $message = $modules->modify_module('gradebook',$can_edit_module);

                //return browser to space home or parent gradebook

                   if ($message=='true') {

                      $modules->return_to_parent('gradebook','modified');
                    exit;
...
if ($_GET['action']=='modify') {
    ...
    $module_data      = $modules->get_module_data('gradebook');
...
if (!isset($_GET['action']) && !isset($_POST['action'])) {
    $action = 'add';
    $title = $gradebook_strings['add_gradebook'];
    $button = $general_strings['add'];
}
...
$t->set_file(array(
    ...
    'form'            => 'gradebook/gradebook_input.ihtml',
...
$modules->set_common_input_vars($page_details,$menus_array,$module_data,$can_edit_module, 'gradebook');
...
$t->set_var('SPACER_INSTRUCTIONS',$gradebook_strings['spacer_intructions']);
