<?php
// significant parts of this SCORM module (including all of this file) were taken 
...
?>
    ...
    function LMSFinish (param) {
        ...
        if (param == "") {
            if (Initialized) {
                ...
                <?php if($scorm->auto) {
					echo "if (cmi.core.lesson_status!='incomplete') {
						setTimeout('top.nextSCO();',500);
    	            }";} ?>
                }    
                return "true";
    ...
    function StoreData(data,storetotaltime) {
        ...
        result = DoRequest(myRequest,"<?php p($CONFIG['PATH']) ?>/modules/scorm/datamodel.php","<?php echo "space_key=$space_key&module_key=$module_key&link_key=$link_key&group_key=$group_key"; ?>"+datastring);
