			...
			case 'createlink':
				oCommand = new dojo.widget.Editor2DialogCommand(editor, name,
						{contentFile: "dojo.widget.Editor2Plugin.CreateLinkDialog",
							...
							title: resources.createLinkDialogTitle, width: "660px", height: "498px",
							lang: this.lang});
				break;
			case 'insertimage':
				oCommand = new dojo.widget.Editor2DialogCommand(editor, name,
						{contentFile: "dojo.widget.Editor2Plugin.InsertImageDialog",
							...
							title: resources.insertImageDialogTitle, width: "610px", height: "530px",
							lang: this.lang});
							
				oCommand.getState=function(){
					var curInst = dojo.widget.Editor2Manager.getCurrentInstance();
					if(curInst._inSourceMode){ return false;}
					var el = dojo.withGlobal(curInst.window, "getAncestorElement", dojo.html.selection, ['img']);
...
nw=Math.min(nw,710);
				oCommand = new dojo.widget.Editor2DialogCommand(editor,name,
						{contentFile: "dojo.widget.Editor2Plugin.InsertAVDialog",
							contentClass: "Editor2InsertAVDialog",
							title: "Insert/Edit Audio or Video",
							width: nw+"px", height: "512px",
							lang: this.lang});
			...
			case 'insertswf':
				oCommand = new dojo.widget.Editor2DialogCommand(editor,name,
						{contentFile: "dojo.widget.Editor2Plugin.InsertSWFDialog",
							contentClass: "Editor2InsertSWFDialog",
							title: "Insert/Edit SWF",
			...
			case 'inserthtmldialog':
				oCommand = new dojo.widget.Editor2DialogCommand(editor,name,
						{contentFile: "dojo.widget.Editor2Plugin.InsertHTMLDialog",
							contentClass: "Editor2InsertHTMLDialog",
							title: "Insert/Edit HTML Chunk",
			...
			default:
				if(name.substr(0,13)=='insertsymbol_') {
					oCommand = new dojo.widget.Editor2DialogCommand(editor, name,
						{contentFile: "dojo.widget.Editor2Plugin.InsertSymbolDialog_"+name.substr(13),
							contentClass: "Editor2InsertSymbolDialog_"+name.substr(13),
							title: 'Insert '+name.substr(13), width: "440px", height: "360px",
							lang: this.lang});
							
					oCommand.getState=function(){
						var curInst = dojo.widget.Editor2Manager.getCurrentInstance();
						return curInst._inSourceMode?
							dojo.widget.Editor2Manager.commandState.Disabled:
							dojo.widget.Editor2Manager.commandState.Enabled;
					}
					oCommand.template=name.substr(13);
				} else {
...
//			dojo.profile.end("dojo.widget.Editor2::editorOnLoad");
	...
	//Since html edit doesn't stretch, all the user some space 
	//FIXME: 100 minimum size should not be hardcoded!
