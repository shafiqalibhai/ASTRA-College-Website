 ...
 */
$cfg['UploadDir']             = '/etc/phpmyadmin';         // Directory for uploaded files that can be executed by
                                            // phpMyAdmin. For example './upload'. Leave empty for
                                            // no upload directory support
$cfg['SaveDir']               = '/etc/phpmyadmin';         // Directory where phpMyAdmin can save exported data on
